...
import { Match, Booking, SeatUpdate } from "@/lib/types";
import { fetchMatch, bookTicket, subscribeSeatUpdates } from "@/lib/api";
...
export default function BookingForm() {
  ...
  const handleBook = async () => {
    if (!userName.trim() || !selectedSeat || !matchId) return;
