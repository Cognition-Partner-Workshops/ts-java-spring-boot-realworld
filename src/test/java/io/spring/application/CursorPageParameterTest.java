...
public class CursorPageParameterTest {
  ...
  public void should_create_cursor_page_parameter_with_next_direction() {
    ...
    CursorPageParameter<LocalDateTime> param = new CursorPageParameter<>(cursor, 10, CursorPager.Direction.NEXT);
  ...
  public void should_create_cursor_page_parameter_with_prev_direction() {
    LocalDateTime cursor = LocalDateTime.now();
    CursorPageParameter<LocalDateTime> param = new CursorPageParameter<>(cursor, 10, CursorPager.Direction.PREV);
  ...
  public void should_handle_null_cursor() {
    CursorPageParameter<LocalDateTime> param = new CursorPageParameter<>(null, 10, CursorPager.Direction.NEXT);
  ...
  public void should_cap_limit_at_max() {
    CursorPageParameter<LocalDateTime> param = new CursorPageParameter<>(null, 2000, CursorPager.Direction.NEXT);
  ...
  public void should_use_default_for_negative_limit() {
    CursorPageParameter<LocalDateTime> param = new CursorPageParameter<>(null, -5, CursorPager.Direction.NEXT);
