...
public class UsersApiTest {
  ...
  public void should_create_user_success() throws Exception {
    ...
    when(userFacade.registerUser(any())).thenReturn(userWithToken);
    ...
    verify(userFacade).registerUser(any());
  }
  ...
  public void should_fail_login_with_wrong_password() throws Exception {
    ...
    when(userFacade.login(eq(email), eq(wrongPassword))).thenThrow(new InvalidAuthenticationException());
