...
public class UsersApiTest {
  ...
  @Test
  public void should_show_error_for_login_with_blank_email() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_login_with_blank_password() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
  ...
  @Test
  public void should_show_error_for_login_with_invalid_email_format() throws Exception {
    Map<String, Object> param =
        new HashMap<String, Object>() {
          {
            put(
