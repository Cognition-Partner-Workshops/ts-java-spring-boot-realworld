...
public class CommentsApiTest extends TestWithCurrentUser {
  ...
  public void should_create_comment_success() throws Exception {
    ...
    when(commentFacade.createComment(eq(article.getSlug()), eq("comment content"), eq(user)))
  ...
  public void should_get_comments_of_article_success() throws Exception {
    ...
    when(commentFacade.getComments(eq(article.getSlug()), eq(null))).thenReturn(comments);
  ...
  public void should_delete_comment_success() throws Exception {
    doNothing().when(commentFacade).deleteComment(eq(article.getSlug()), eq(comment.getId()), eq(user));
  ...
  public void should_get_403_if_not_author_of_article_or_author_of_comment_when_delete_comment()
    ...
    doThrow(new NoAuthorizationException())
        .when(commentFacade).deleteComment(eq(article.getSlug()), eq(comment.getId()), eq(anotherUser));
